...
public class BigbasketJavaMethods {
	...
	public void go_To_Ponni_Boiled_Rice_Select_Kg_Bag_Dropdown() {
		driver.findElementByXPath(
				"(//a[text()='Ponni Boiled Rice/Puzhungal Arisi']/following::div[@class='btn-group btn-input clearfix ng-scope'])[1]")
				.click();
		driver.findElementByXPath(
				"(//a[text()='Ponni Boiled Rice/Puzhungal Arisi']/following::span[contains(text(),'10 kg')])[1]")
				.click();
	...
	public void click_Add_Button() throws InterruptedException {
		driver.findElementByXPath("(//a[text()='Ponni Boiled Rice/Puzhungal Arisi']/following::button[@qa='add'])[1]")
				.click();
		Thread.sleep(2000);
	}
	...
	public void click_Address() throws InterruptedException {
		...
		WebElement address = driver
				.findElementByXPath("//span[@ng-bind='vm.user.currentAddress.address_display_name']");
